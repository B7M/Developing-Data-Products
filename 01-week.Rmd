...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Screenshot of the running slider app', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1DKI3TzXsb8-ZrC1QkA1wwHHzfGaVKkPYgbuwv9fW-kY/edit?pli=1#slide=id.g256d971af02_1_5")
```
...
```{r, echo = F,eval=T}
plot.new()
polygon(c(0, 0, .4, .4), c(0, 1, 1, 0))
text(mean(c(0, 0, .4, .4)), mean(c(0, 1, 1, 0)), "Box 1")
text(.5,.5,"+",cex = 1.8)
polygon(c(.6, .6, 1, 1), c(0, 1, 1, 0))
text(mean(c(.6, .6, 1, 1)), mean(c(0, 1, 1, 0)), "Box 2")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='A missing comma results in error mark on line 8', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1DKI3TzXsb8-ZrC1QkA1wwHHzfGaVKkPYgbuwv9fW-kY/edit?pli=1#slide=id.g256d971af02_1_1")
```
...
```{r, fig.alt="Alternative text", fig.height=6, fig.align='center', fig.cap='Steps after launch_editor(app_loc = "App") command', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1DKI3TzXsb8-ZrC1QkA1wwHHzfGaVKkPYgbuwv9fW-kY/edit?pli=1#slide=id.g256d971af02_1_9")
```
...
pickTrees <- function() {
  ui <- miniPage(gadgetTitleBar("Select Points by Dragging your Mouse"),
    miniContentPanel(
