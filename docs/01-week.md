...
Be sure to avoid errors in your R code while making UI changes, as RStudio will show you X's in the code if you forget to close parentheses or add commas as shown in Fig. 1.2. Proper indentation and using a nice environment like RStudio will make the task easier.
